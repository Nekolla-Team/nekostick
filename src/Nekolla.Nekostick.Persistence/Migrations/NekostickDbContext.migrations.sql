...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM nekostick."__EFMigrationsHistory" WHERE "MigrationId" = '20260908050058_AddExtensionContentAndNodeState') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM nekostick."__EFMigrationsHistory" WHERE "MigrationId" = '20260908050058_AddExtensionContentAndNodeState') THEN
    INSERT INTO nekostick."__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260908050058_AddExtensionContentAndNodeState', '10.0.11');
    END IF;
END $EF$;
COMMIT;
